...
function Home() {
    ...
    const [retrievedSongIndex, setRetrievedSongIndex] = React.useState('');
        ...
        <div className="home-container">
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container">
                    <a className="navbar-brand" href="#">tunefinder</a>
            ...
            <div className="row justify-content-center">
                ...
                <div className="container mt-5">
                    ...
                    {activeView === 'recommendations' && <SongList endpoint={`recommendations?query=${retrievedSongIndex}`} title="Recommendations" />}
